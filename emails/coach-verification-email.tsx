...
export default function CoachVerificationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your FTC Pitfund coach account is now verified 🎉</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            Great news — an FTC Pitfund admin has reviewed and approved your coach credentials. You now have full access to the platform.
          </Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            FTC Pitfund · You received this email because you created a coach account on our platform.
          </Text>
        </Container>
      </Body>
    </Html>
